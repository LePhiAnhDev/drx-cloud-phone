...
const PlatformIcons = {
  ...
  shopee: (props: React.SVGProps<SVGSVGElement>) => (
    <svg {...props} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" xmlns="http://www.w3.org/2000/svg">
      <path d="M3.5 4.5h17l-1.5 9h-14z"/>
      <path d="M6 13.5l-1.5 6h15l-1.5-6"/>
...
const PlatformOrbit = () => {
  ...
  const outerIcons = [
    { 
      id: 1, 
      component: <PlatformIcons.tiktok className="w-10 h-10 text-foreground/90" />,
      name: "TikTok" 
    },
    { 
      id: 2, 
      component: <Facebook className="w-10 h-10 text-foreground/90" />,
      name: "Facebook" 
    },
    { 
      id: 3, 
      component: <Instagram className="w-10 h-10 text-foreground/90" />,
      name: "Instagram" 
    },
    { 
      id: 4, 
      component: <Icons.google className="w-10 h-10 text-foreground/90" />,
      name: "Google" 
    },
    { 
      id: 5, 
      component: <Youtube className="w-10 h-10 text-foreground/90" />,
      name: "YouTube" 
    },
    { 
      id: 6, 
      component: <PlatformIcons.shopee className="w-10 h-10 text-foreground/90" />,
      name: "Shopee" 
    },
    { 
      id: 7, 
      component: <PlatformIcons.x className="w-10 h-10 text-foreground/90" />,
      name: "X" 
    },
  ];
